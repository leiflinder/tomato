...
<body>
    <table>
        ...
        <input type='hidden' name='tomato' value='25'>
            <tr>
                <td>25 Min</td><td><input type='submit' value='START'></td>
            </tr>
        </form>
    </table>
    <?php
...
//$oldTimestamp;
$minutes = 1500;  
$plus_25 = $now_unix_TS + 1500;  
// $newTimestamp = strtotime('+ ' . $minutes . ' minutes', $now_unix_TS);
// $plus_25 = 0;
print('<h3>'.$now_unix_TS.' plus 25 minutes is '.$plus_25.'</h3>');
?>
<div class="cd-tab">
